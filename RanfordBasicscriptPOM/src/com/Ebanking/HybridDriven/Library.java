...
public class Library {
	...
	public String OpenApp (String url) throws IOException {
		...
		fis=new FileInputStream("E:\\Ebanking\\RanfordBasicscriptPOM\\src\\com\\Ebanking\\KeywordDriven\\Rep.properties");
		pro=new Properties();
		pro.load(fis);
...
//click on emp
	...
	public void logout() {
		...
		driver.findElement(By.xpath(pro.getProperty("lgtb"))).click();
